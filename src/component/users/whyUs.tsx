    ...
    <>
      <section id="whyUs" className="whyUs">
        <div className="container-xl">
          <div className="whyUs__content d-flex flex-column">
            <div className="whyUs_text d-flex flex-column">
              <h2 className="heading2-font whyUs__heading">Why Us</h2>
              <p className="paragraph-font whyUs__paragraph">
                Mengapa harus pilih Binar Car Rental?
              </p>
            </div>
            <div className="d-flex flex-md-row flex-column">
              <div className="whyUs__card d-flex flex-column gap-3 col-md-3 border p-3 rounded-2">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 32 32"
                ...
                <h3 className="title-font">Mobil Lengkap</h3>
              ...
              <div className="whyUs__card d-flex flex-column gap-3 col-md-3 border p-3 rounded-2">
                ...
                <h3 className="title-font">Harga Murah</h3>
                <p className="paragraph-font">
              ...
              <div className="whyUs__card d-flex flex-column gap-3 col-md-3 border p-3 rounded-2">
                ...
                <h3 className="title-font">Layanan 24 Jam</h3>
                <p className="paragraph-font">
              ...
              <div className="whyUs__card d-flex flex-column gap-3 col-md-3 border p-3 rounded-2">
                ...
                <h3 className="title-font">Sopir Profesional</h3>
                <p className="paragraph-font">
