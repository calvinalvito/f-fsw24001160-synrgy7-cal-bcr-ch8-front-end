    ...
    <>
      <section id="footer" className="footer">
        <div className="container-xl">
          <div className="footer__content d-flex flex-md-row flex-column justify-content-between">
            <div className="footer__address d-flex flex-column">
              <p className="paragraph-font">
                Jalan Suroyo No. 161 Mayangan Kota <br /> Probolonggo 672000
              </p>
              <p className="paragraph-font">binarcarrental@gmail.com</p>
              <p className="paragraph-font">081-233-334-808</p>
            </div>
            <div className="footer__service d-flex flex-column">
              <p className="paragraph-font">Our services</p>
              <p className="paragraph-font">Why Us</p>
              <p className="paragraph-font">Testimonial</p>
              <p className="paragraph-font">FAQ</p>
            </div>
            <div className="footer__sosmed d-flex flex-column">
              <p className="paragraph-font">Connect with us</p>
              <div className="d-flex flex-row footer__icon">
                <a href="">
                  <svg
                    width="32"
                    height="32"
            ...
            <div className="footer__copyright">
              <p className="paragraph-font">Copyright Binar 2022</p>
            </div>
          </div>
        </div>
      </section>
